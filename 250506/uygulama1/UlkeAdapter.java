...
public class UlkeAdapter extends BaseAdapter {
    ...
    @Override
    public View getView(int i, View view, ViewGroup viewGroup) { //liste gorunumu olusturulur
        ImageView ivSatirBayrak;
        TextView tvSatirAd,tvSatirBaskent,tvSatirNufus;

        Ulke ulke=ulkeler.get(i); /* sıradaki ulke nesnesi elde edilir */

        if (view == null){
            view =View.inflate(context, R.layout.satir, null);
        }

        /* xxl'de tanımlı bileşenler ayarlanır */
        ...
        /* her bilesene ulke nesnesinden degerler atanır */
